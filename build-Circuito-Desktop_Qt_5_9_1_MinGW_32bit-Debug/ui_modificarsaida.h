...
public:
    ...
    {
        ModificarSaida->setWindowTitle(QApplication::translate("ModificarSaida", "Dialog", Q_NULLPTR));
        labelSaida->setText(QApplication::translate("ModificarSaida", "SA\303\215DA:", Q_NULLPTR));
        labelIdSaida->setText(QString());
        labelOrigemSaida->setText(QApplication::translate("ModificarSaida", "Id da origem:", Q_NULLPTR));
    } // retranslateUi
