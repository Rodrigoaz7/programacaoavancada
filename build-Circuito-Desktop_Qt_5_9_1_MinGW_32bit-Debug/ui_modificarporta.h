...
public:
    ...
    {
        ModificarPorta->setWindowTitle(QApplication::translate("ModificarPorta", "Dialog", Q_NULLPTR));
        labelPorta->setText(QApplication::translate("ModificarPorta", "PORTA:", Q_NULLPTR));
        labelIdPorta->setText(QString());
        labelTipoPorta->setText(QApplication::translate("ModificarPorta", "Tipo da porta:", Q_NULLPTR));
        labelNumInputs->setText(QApplication::translate("ModificarPorta", "N\302\272 de entradas:", Q_NULLPTR));
        labelInput1->setText(QApplication::translate("ModificarPorta", "Id da entrada 1:", Q_NULLPTR));
        labelInput2->setText(QApplication::translate("ModificarPorta", "Id da entrada 2:", Q_NULLPTR));
        labelInput3->setText(QApplication::translate("ModificarPorta", "Id da entrada 3:", Q_NULLPTR));
        labelInput4->setText(QApplication::translate("ModificarPorta", "Id da entrada 4:", Q_NULLPTR));
    } // retranslateUi
